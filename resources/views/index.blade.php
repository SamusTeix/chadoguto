	...
	<div class="jumbotron">
		<div class="row">
			<div class="col-8">
			  ...
			  <p class="lead">
			  	Como eu quis vir no meio da pandemia a mamãe e o papai não estão conseguindo visitar a família e nem amigos. Por causa disso também não poderão fazer meu chá de bebê e nem convidar vocês para irem me ver logo quando eu chegar.
			  </p>
			  <hr class="my-4">
				<p>
					Apesar de ficarmos tristes com isso muita gente querida por nós está querendo dar uma lembrancinha para minha chegada e para eu não ficar com coisinhas repetidas, a mamãe e o papai resolveram fazer essa listinha de todo meu enxoval, para as pessoas que querem me dar algo ficarem à vontade para escolher.
				</p>
				<p>
				...
				<p>
					Também sabemos que está difícil para algumas pessoas saírem, por serem do grupo de risco ou só por precaução, sem contar que algumas lojas estão fechadas. Nesse caso temos algumas sugestões de lojas online e de alguns itens que combinam com a decoração do meu quartinho, caso vocês queiram dar uma olhada e ver algum produto que já selecionamos e fazer a compra do jeito que fica melhor.
				</p>
				<p>
					Para entregar meu presentinho temos duas opções, pode ser feito pessoalmente, assim vamos nos ver de longe ou entrega pelos correios (nas compras virtuaais) e quando as coisas melhorarem iremos nos ver de pertinho.
				</p>
				<p>
