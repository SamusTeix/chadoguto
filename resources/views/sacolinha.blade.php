				...
				<div class="tab-main">
					...
					<div class="tab-content hide" pos="2">
						<div class="row">
							...
							<div class="card col-6 text-center card_tipo" onClick="selectTipo(this, 1)" role="button">
								<div class="card-body">
							...
							<div class="card col-6 text-center card_tipo" onClick="selectTipo(this, 2)" role="button">
